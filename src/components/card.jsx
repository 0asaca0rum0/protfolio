    ...
    return (
        <div className="group min-w-80 sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl h-[550px] md:h-[450px] lg:h-[500px] rounded-lg shadow-lg overflow-hidden relative hover:scale-105 transition-all">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-30">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg text-white transition-all duration-500 ease-in-out group-hover:max-h-full max-h-[16%] md:max-h-[20%] overflow-hidden">
