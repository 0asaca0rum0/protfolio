        ...
        >
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-screen-2xl">
                <div className={`w-full mx-auto p-8 ${!isDarkMode
                    ...
                    : 'bg-gray-400 bg-opacity-15 shadow-[rgba(0,_0,_0,_0.1)_0px_60px_40px_-7px] rounded-xl '} backdrop-filter backdrop-blur-sm md:backdrop-blur-md  transition-colors duration-300`}>
